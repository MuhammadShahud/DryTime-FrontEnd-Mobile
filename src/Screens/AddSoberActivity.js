...
class AddSoberActivity extends Component {
    constructor(props) {
        super(props);
        this.state = {
            type: activities[this.props.route.params?.type],
            title: '',
            duration: "",
            description: "",
            file: {
                        ...
                        launchCamera({
                            ...
                            if (!response.errorCode && !response.didCancel) {
                                ...
                                this.setState({
                                    ...
                                    duration: this.addZero(minutes.toFixed(0)) + ":" + this.addZero(seconds)
                                    // fileDimension: {
                                    //     height: img.height,
                                    //     width: img.width
                                    // },
    ...
    UploadVideo = async () => {
        let { description, file, title, duration, type } = this.state;
        if (!description || !file.uri || !title || !duration) {
        ...
        this.props.AddActivity({
            ...
            type: this.getSoberActivity(type),
            description,
            file,
            title,
            duration,
                    ...
                    <View style={styles.body}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <SelectDropdown
                                ...
                                data={activities}
                                defaultValue={activities[this.props.route.params?.type]}
...
const mapDispatchToProps = dispatch => ({
    AddActivity: data => dispatch(ActivityMiddleware.addActivity(data)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AddSoberActivity);
